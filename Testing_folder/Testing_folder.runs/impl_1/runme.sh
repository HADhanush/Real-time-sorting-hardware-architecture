...
HD_PWD='C:/Users/dhanu/Desktop/Major_project/Final_codes/Testing_folder/Testing_folder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_rand_fifo_sort.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_rand_fifo_sort.tcl -notrace
