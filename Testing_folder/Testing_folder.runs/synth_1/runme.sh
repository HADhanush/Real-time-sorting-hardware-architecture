...
HD_PWD='C:/Users/dhanu/Desktop/Major_project/Final_codes/Testing_folder/Testing_folder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_rand_fifo_sort.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_rand_fifo_sort.tcl
